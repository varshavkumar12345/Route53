    ...
    <div className={styles.overlay} onClick={handleClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.header}>
          ...
          <button className={styles.closeButton} onClick={handleClose} disabled={disabled}>
        ...
        <form onSubmit={handleConfirmSubmit}>
          ...
          <div className={styles.footer}>
            <button type="button" className="btn-secondary" onClick={handleClose} disabled={disabled}>
              {cancelLabel}
            </button>
            <button
              type="submit"
              className={`btn-primary ${styles.confirmBtn}`}
              disabled={isConfirmedDisabled || disabled}
              style={{
                backgroundColor: isConfirmedDisabled || disabled ? "#eaeded" : "#d13212",
                borderColor: isConfirmedDisabled || disabled ? "#eaeded" : "#d13212",
                color: isConfirmedDisabled || disabled ? "#aab7b8" : "#ffffff",
                cursor: isConfirmedDisabled || disabled ? "not-allowed" : "pointer"
              }}
            >
              {confirmLabel}
            </button>
